...
#------------items2-----------#
        FF2=Frame(root,bd=2,width=350,height=745,bg='#0B4C5F')
        ...
        #------------items3-----------#
        FF3=Frame(root,bd=2,width=350,height=550,bg='#0B4C5F')
        ...
        br13=Label(FF3,text='automatic washing machine ',font=('tajawal',14),bg='#0B4C5F',fg='white')
        br13.place(x=30,y=530)
        br14=Label(FF3,text='iron',font=('tajawal',14),bg='#0B4C5F',fg='white')
        br14.place(x=30,y=570)
        br15=Label(FF3,text='cooler',font=('tajawal',14),bg='#0B4C5F',fg='white')
        br15.place(x=30,y=610)
       

        bqent1=Entry(FF3,width=12)
        bqent1.place(x=170,y=55)

        bqrnt2=Entry(FF3,width=12)
        bqrnt2.place(x=170,y=95)
        bqrnt3=Entry(FF3,width=12)
        bqrnt3.place(x=170,y=135)
        bqrnt4=Entry(FF3,width=12)
        bqrnt4.place(x=170,y=175)
        bqrnt5=Entry(FF3,widtlh=12)
        bqrnt5.place(x=170,y=215)
        bqrnt6=Entry(FF3,width=12)
        bqrnt6.place(x=170,y=255)
        bqrnt7=Entry(FF3,width=12)
        bqrnt7.place(x=170,y=295)
        bqrnt8=Entry(FF3,width=12)
        bqrnt8.place(x=170,y=335)
        bqrnt9=Entry(FF3,width=12)
        bqrnt9.place(x=170,y=375)
        bqrnt10=Entry(FF3,width=12)
        bqrnt10.place(x=170,y=415)
        bqrnt11=Entry(FF3,width=12)
        bqrnt11.place(x=170,y=455)
        bqrnt12=Entry(FF3,width=12)
        bqrnt12.place(x=170,y=495)
        bqrnt13=Entry(FF3,width=12)
        bqrnt13.place(x=170,y=535)
        bqrnt14=Entry(FF3,width=12)
        bqrnt14.place(x=170,y=575)
        bqrnt15=Entry(FF3,width=12)
        bqrnt15.place(x=170,y=615)
