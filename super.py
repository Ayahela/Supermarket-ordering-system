...
#------------items2-----------#
        ...
        br13=Label(FF3,text='automatic  ',font=('tajawal',14),bg='#0B4C5F',fg='white')
        ...
        bqnt1.place(x=170,y=55)

        bqnt2=Entry(FF3,width=12)
        bqnt2.place(x=170,y=95)
        bqnt3=Entry(FF3,width=12)
        bqnt3.place(x=170,y=135)
        bqnt4=Entry(FF3,width=12)
        bqnt4.place(x=170,y=175)
        bqnt5=Entry(FF3,widtlh=12)
        bqnt5.place(x=170,y=215)
        bqnt6=Entry(FF3,width=12)
        bqrnt6.place(x=170,y=255)
        bqnt7=Entry(FF3,width=12)
        bqnt7.place(x=170,y=295)
        bqnt8=Entry(FF3,width=12)
        bqnt8.place(x=170,y=335)
        bqnt9=Entry(FF3,width=12)
        bqnt9.place(x=170,y=375)
        bqnt10=Entry(FF3,width=12)
        bqnt10.place(x=170,y=415)
        bqnt11=Entry(FF3,width=12)
        bqnt11.place(x=170,y=455)
        bqnt12=Entry(FF3,width=12)
        bqnt12.place(x=170,y=495)
        bqnt13=Entry(FF3,width=12)
        bqnt13.place(x=170,y=535)
        bqnt14=Entry(FF3,width=12)
        bqnt14.place(x=170,y=575)
        bqnt15=Entry(FF3,width=12)
        bqnt15.place(x=170,y=615)
